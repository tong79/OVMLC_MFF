...
from helper_functions import calc_F1, get_knns,mAP
...
def main_fun():
    ...
    train_dataset = dataset.CocoDataset('/home/ttl/dataset/COCO//train2014',
                                        '/home/ttl/dataset/COCO//annotations/instances_train2014.json',
    ...
    test_zsl_dataset = dataset.CocoDataset('/home/ttl/dataset/COCO//val2014',
                                           '/home/ttl/dataset/COCO//annotations/instances_val2014.json',mode='val',
    ...
    test_gzsl_dataset = dataset.CocoDataset('/home/ttl/dataset/COCO//val2014',
                                            '/home/ttl/dataset/COCO/annotations/instances_val2014.json',mode='val',
                                            transform=dataset.transform_test, label_set=all_label_set)
