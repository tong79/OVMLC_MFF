...
def download(element):
    ...
    for i in range(5):
        try:
            response = requests.get(element[0],headers=random.choice(browser_headers),proxies={'https':'127.0.0.1:7890'},verify=False,allow_redirects=False)
...
if __name__ == "__main__":
    ...
    save_directory_path = 'images/'+data_set+'/'
