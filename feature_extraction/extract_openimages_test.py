...
version = '2018_04'
path = '/home/ttl/mlc/datasets/OpenImages/{}'.format(version)
data_set = 'test'
...
for idx_partition, partition in enumerate(partition_df):
    file_partition = [img_id + '.jpg' for img_id in partition['ImageID'].unique() if
                      os.path.isfile(data_path + img_id + '.jpg')]
